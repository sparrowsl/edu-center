...
export default function Faculty() {
	return (
		<>
			<div class="bg-#F0F0F0">
				<article class="container flex px-4 flex-col mx-auto mx-5 py-10 min-h-80svh justify-center items-center">
					<SectionHeader
						title="Our Faculty"
            ...
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo. `}
					...
					<section class="grid mt-15 px-7 gap-10 md:(grid-cols-3 px-5) justify-center">
